            ...
            <div className="mt-3 mb-2">
                <nav>
                    <div className="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        data-bs-toggle="tab" data-bs-target="#nav-send-message" type="button"
                        role="tab" aria-controls="nav-send-message" aria-selected="true">
                            Submit Question
                        </button>
                        <button onClick={()=> setMessageClick(true)} className="nav-link" id="nav-message-tab"
